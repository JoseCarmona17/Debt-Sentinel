        ...
        <section className="flex flex-col gap-stack-lg border-l border-r border-white/10 px-4 sm:px-8 py-8 sm:py-16 relative">
          ...
          <div className="max-w-4xl flex flex-col gap-stack-md mt-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              <button className="bg-primary-container text-on-primary-fixed font-label-mono text-label-mono px-6 sm:px-8 py-4 border border-primary-container hover:bg-white transition-colors hard-shadow flex items-center justify-center gap-2 w-full sm:w-auto">
                GET THE DIAGNOSTIC
                <span className="material-symbols-outlined text-[16px]">arrow_forward</span>
              </button>
              <button className="bg-transparent text-white font-label-mono text-label-mono px-6 sm:px-8 py-4 border border-white hover:border-primary-container hover:text-primary-container transition-colors flex items-center justify-center gap-2 w-full sm:w-auto">
                VIEW LEXICOGRAPHY
